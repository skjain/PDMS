...
Begin VB.Form FrmChangeTaxCategory 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Change Tax Category"
   ClientHeight    =   4695
   ClientLeft      =   5295
   ClientTop       =   2205
   ClientWidth     =   8070
   ...
   Begin FramePlusCtl.FramePlus FramePlus1 
      ...
      Begin VB.PictureBox Search 
         ...
         Height          =   300
         Left            =   3720
         Picture         =   "FrmChangeTaxCategory.frx":0000
         ScaleHeight     =   240
         ScaleWidth      =   240
         TabIndex        =   4
         Top             =   1440
      ...
      Begin WelchButton.lvButtons_H cmdDelete 
         ...
         Mode            =   0
         Value           =   0   'False
         Image           =   "FrmChangeTaxCategory.frx":058A
         cBack           =   -2147483633
      End
      Begin WelchButton.lvButtons_H cmdCancel 
         ...
         Mode            =   0
         Value           =   0   'False
         Image           =   "FrmChangeTaxCategory.frx":0B24
         cBack           =   -2147483633
      End
      Begin WelchButton.lvButtons_H cmdExit 
         ...
         Mode            =   0
         Value           =   0   'False
         Image           =   "FrmChangeTaxCategory.frx":0F76
         cBack           =   -2147483633
      End
      Begin VB.Label lblAlert 
         BackStyle       =   0  'Transparent
         Caption         =   "Change Tax Category For Challan And Invoice"
         BeginProperty Font 
   ...
   End
End
Attribute VB_Name = "FrmChangeTaxCategory"
