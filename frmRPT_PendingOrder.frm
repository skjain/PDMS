...
Begin VB.Form frmRPT_PendingOrder 
   ...
   Begin VB.Frame Frame4 
      ...
      Begin WelchButton.lvButtons_H cmdpreview 
         ...
         Mode            =   0
         Value           =   0   'False
         Image           =   "frmRPT_PendingOrder.frx":0000
         cBack           =   -2147483633
      End
      Begin WelchButton.lvButtons_H cmdExit 
         ...
         Mode            =   0
         Value           =   0   'False
         Image           =   "frmRPT_PendingOrder.frx":0452
         cBack           =   -2147483633
      End
   ...
   End
End
Attribute VB_Name = "frmRPT_PendingOrder"
...
On Error GoTo errPreview
    ...
    ") AND {ORDMAN.ORDT}<=DATE(" & Year(dtTo) & "," & Month(dtTo) & "," & Day(dtTo) & ") " & _
    "AND {ORDMAN.RECSTAT}<>'D' AND ({ORDMAN.QNTY} - {ORDMAN.DISPATCHQTY} - {ORDMAN.CANCELQTY}) > 0.001"
    ...
    If cboReports.ListIndex = 0 Then
            ReportName = App.PATH & "\Reports\PartywiseSummarisedPendingOrder.rpt"
            RPTN = "PARTYWISE SUMMARISED PENDING ORDER REPORT"
    ElseIf cboReports.ListIndex = 1 Then
            ReportName = App.PATH & "\Reports\AgentwiseSummarisedPendingOrder.rpt"
            RPTN = "AGENTWISE SUMMARISED PENDING ORDER REPORT"
    ElseIf cboReports.ListIndex = 2 Then
            ReportName = App.PATH & "\Reports\ItemwiseSummarisedPendingOrder.rpt"
            RPTN = "ITEMWISE PENDING ORDER REPORT "
    ElseIf cboReports.ListIndex = 3 Then
            ReportName = App.PATH & "\Reports\GradewiseSummarisedPendingOrder.rpt"
            RPTN = "GRADEWISE PENDING ORDER REPORT "
    ElseIf cboReports.ListIndex = 4 Then
            ReportName = App.PATH & "\Reports\DatewiseSummarisedPendingOrder.rpt"
            RPTN = "DATEWISE PENDING ORDER REPORT "
    End If
...
Call ColorComponent(Me)
    ...
    With cboReports
        .AddItem "PARTYWISE ORDER PENDING REPORT"
        .AddItem "AGENTWISE ORDER PENDING REPORT"
        .AddItem "ITEMWISE ORDER PENDING REPORT"
        .AddItem "GRADEWISE ORDER PENDING REPORT"
        .AddItem "DATEWISE ORDER PENDING REPORT"
        .ListIndex = 0
    End With
