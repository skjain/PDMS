...
Begin VB.Form frm_excisedbreg 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Excise Debit Register"
   ClientHeight    =   3750
   ClientLeft      =   4470
   ClientTop       =   1890
   ClientWidth     =   5460
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame4 
         ...
         Begin WelchButton.lvButtons_H cmdPreview 
            ...
            Mode            =   0
            Value           =   0   'False
            Image           =   "frm_excisedbreg.frx":0000
            cBack           =   -2147483633
         End
         Begin WelchButton.lvButtons_H cmdCancel 
            ...
            Mode            =   0
            Value           =   0   'False
            Image           =   "frm_excisedbreg.frx":0452
            cBack           =   -2147483633
         End
   ...
   End
End
Attribute VB_Name = "frm_excisedbreg"
...
If RS.State = 1 Then RS.Close
    ...
    ReportName = App.PATH & "\Reports\Direct Debit Entry Register.rpt"
    
    rptsql = "{EGPMAN.COMP}='" & compPth & "' and ({EGPMAN.VTYP}='EXD') and {EGPMAN.RECSTAT}<>'D' AND {EGPMAN.DATE}>=DATE(" & Year(dtFrom) & "," & Month(dtFrom) & "," & Day(dtFrom) & ") AND {EGPMAN.DATE}<=DATE(" & Year(dtTo) & "," & Month(dtTo) & "," & Day(dtTo) & ") AND {EGPMAN.CENVAT} > 0 "
    
    If Not cboexreg.Text = "<All>" Then rptsql = rptsql + " AND {EGPMAN.ttyp}='" & cboexreg.Text & "'"
    
    RPTN = "Direct Excise Debit Register "
    ...
    With CRPT
        ...
        If ReadConfigMaster("000082", 8, "R") Then
