...
Begin VB.Form frmRPT_StoreRetItem 
   AutoRedraw      =   -1  'True
   ...
   Begin VB.Frame Frame4 
      ...
      Begin WelchButton.lvButtons_H cmdpreview 
         ...
         Mode            =   0
         Value           =   0   'False
         Image           =   "frmRPT_StoreRetItem.frx":0000
         cBack           =   -2147483633
      End
      Begin WelchButton.lvButtons_H cmdCancel 
         ...
         Mode            =   0
         Value           =   0   'False
         Image           =   "frmRPT_StoreRetItem.frx":0452
         cBack           =   -2147483633
      End
   ...
   End
End
Attribute VB_Name = "frmRPT_StoreRetItem"
...
Me.KeyPreview = False
    ...
    RPTN = Empty
        ...
        If cboReports.ListIndex = 0 Then
           ReportName = App.PATH & "\Reports\StoreRetRegister.rpt"
           RPTN = "STORE RETURN REGISTER"
        ElseIf cboReports.ListIndex = 1 Then
           ReportName = App.PATH & "\Reports\StoreRetRegister(COSTHEAD).rpt"
           RPTN = "COST HEAD WISE STORE RETURN REGISTER"
        End If
...
Private Sub Form_Activate()
 ...
 With cboReports
       .Clear
       .AddItem "Return Register"
       .AddItem "Cost Head wise Return Register"
       cboReports.ListIndex = 0
       Me.Caption = "Store Item Return Register"
 End With
End Sub
...
Private Sub SetSQL()
 ...
 rptsql = rptsql & " AND {STORETRAN.RECSTAT}<>'D' AND {STORETRAN.VTYP}='RTI'"
