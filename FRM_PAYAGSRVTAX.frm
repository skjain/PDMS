...
Begin VB.Form FRM_PAYAGSRVTAX 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame4 
         ...
         Begin WelchButton.lvButtons_H cmdPreview 
            ...
            Mode            =   0
            Value           =   0   'False
            Image           =   "FRM_PAYAGSRVTAX.frx":0000
            cBack           =   -2147483633
         End
         Begin WelchButton.lvButtons_H cmdCancel 
            ...
            Mode            =   0
            Value           =   0   'False
            Image           =   "FRM_PAYAGSRVTAX.frx":0452
            cBack           =   -2147483633
         End
   ...
   End
End
Attribute VB_Name = "FRM_PAYAGSRVTAX"
...
If RS.State = 1 Then RS.Close
    ...
    ReportName = App.PATH & "\Reports\Service Tax Paid Report.RPT"

    rptsql = "{SERVICEREP.COMP}='" & compPth & "' AND {SERVICEREP.DATE}>=DATE(" & Year(dtFrom) & "," & Month(dtFrom) & "," & Day(dtFrom) & ") AND {SERVICEREP.DATE}<=DATE(" & Year(dtTo) & "," & Month(dtTo) & "," & Day(dtTo) & ") "
    
    RPTN = "Payment Register Against Service Tax "
    ...
    rptsql = rptsql & " AND {SERVICEREP.UNIT} IN [" & txtUNIT.Tag & "]"
    ...
    With CRPT
        ...
        If ReadConfigMaster("000083", 8, "R") Then
