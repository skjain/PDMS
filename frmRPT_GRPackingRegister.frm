...
Begin VB.Form frmRPT_GRPackingRegister 
   ...
   Begin VB.Frame Frame5 
      ...
      Begin WelchButton.lvButtons_H cmdpreview 
         ...
         Mode            =   0
         Value           =   0   'False
         Image           =   "frmRPT_GRPackingRegister.frx":0000
         cBack           =   -2147483633
      End
      Begin WelchButton.lvButtons_H cmdExit 
         ...
         Mode            =   0
         Value           =   0   'False
         Image           =   "frmRPT_GRPackingRegister.frx":0452
         cBack           =   -2147483633
      End
   ...
   End
End
Attribute VB_Name = "frmRPT_GRPackingRegister"
...
'FILTERATION CRITERIA
    ...
    If Not TXTPKGSTATION = Empty Then rptsql = rptsql & " AND {GRPACKING.PKG_STCOD} = '" & TXTPKGSTATION.Tag & "'"
        
     
        ReportName = App.PATH & "\Reports\DateWiseGRPackingRegister.RPT"
        RPTN = "DATEWISE GR PACKING REGISTER"
