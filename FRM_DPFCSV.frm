...
Private Sub CMDDSP_Click()
 ...
 Call SetFile(QRY, "C:\DOSPRINT\Dispatch.csv")
End Sub
...
If M_COMPBILL = "SLS" Then
 ...
 FILENAME = Trim(txtDONO) + "_" + Trim(txtLTNo) + "_" + Trim(txtGrade) + "_" + Trim(TXTSUBGRD) + "_" + Trim(nstr(txtQTY, 12, 3))
...
End If
 ...
 If RS.State = 1 Then RS.Close
 RS.Open QRY, CN, adOpenDynamic, adLockOptimistic
 Call SetFile(QRY, TXTFILE & FILENAME & ".csv")
