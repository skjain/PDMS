...
Begin VB.Form frmRpt_saleRegistermfg 
   ...
   Begin VB.Frame Frame4 
      ...
      Begin WelchButton.lvButtons_H cmdpreview 
         ...
         Mode            =   0
         Value           =   0   'False
         Image           =   "frmRpt_saleRegistermfg.frx":0000
         cBack           =   -2147483633
      End
      Begin WelchButton.lvButtons_H cmdCancel 
         ...
         Mode            =   0
         Value           =   0   'False
         Image           =   "frmRpt_saleRegistermfg.frx":0452
         cBack           =   -2147483633
      End
   ...
   End
End
Attribute VB_Name = "frmRpt_saleRegistermfg"
...
On Error GoTo errPreview
    ...
    If CMBTYP = "<ALL>" Then
     ...
     Else
      If RS.State = 1 Then RS.Close
      RS.Open "select code from serialmaster where comp='" & compPth & "' and unit='" & m_unit & "' and name='" & Trim(CMBTYP) & "' and fycd='" & FYCD & "' AND VTYP = 'SAL'", CN, adOpenDynamic, adLockOptimistic
      If Not RS.EOF Then
   ...
   End If
    ...
    Select Case cboFormat.ListIndex
        Case 0
            ReportName = App.PATH & "\Reports\Sale Register(Mfg) Date Wise.rpt"
        Case 1
            ReportName = App.PATH & "\Reports\Sale Register(Mfg) Party Wise.rpt"
        Case 2
            ReportName = App.PATH & "\Reports\Sale Register(Mfg) Sales Tax Form Wise.rpt"
        Case 3
            ReportName = App.PATH & "\Reports\Sale Register(Mfg) Agent Wise.rpt"
        Case 4
            ReportName = App.PATH & "\Reports\Sale register tax wise C-form report.rpt"
        Case 5
            ReportName = App.PATH & "\Reports\Sale Register(Mfg) Date Wise with excise detail.rpt"
        Case 6
            ReportName = App.PATH & "\Reports\Sale Register(Mfg) Date Wise2.rpt"
        Case 7
            ReportName = App.PATH & "\Reports\Sale Register(Mfg) Date Wise3.rpt"
        Case Else
