...
Begin VB.Form frmEditOpnCformPay 
   AutoRedraw      =   -1  'True
   ...
   Begin WelchButton.lvButtons_H cmdOk 
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frmEditOpnCformPay.frx":0000
      cBack           =   -2147483633
   End
   Begin WelchButton.lvButtons_H cmdExit 
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frmEditOpnCformPay.frx":0D8A
      cBack           =   -2147483633
   End
   ...
   End
End
Attribute VB_Name = "frmEditOpnCformPay"
...
SQL = "SELECT PURMAN.*,ACCMST.NAME AS ACNM,REFMST.NAME AS AGENT FROM PURMAN "
SQL = SQL & "INNER JOIN ACCMST ON ACCMST.CODE=PURMAN.PCOD "
SQL = SQL & "INNER JOIN REFMST ON REFMST.CODE = PURMAN.BRCD "
SQL = SQL & "WHERE PURMAN.COMP='" & compPth & "' AND PURMAN.UNIT='" & UNCD & _
"' AND PURMAN.DVCD='" & DIVCODE & "' AND PURMAN.VTYP='OPC' AND PURMAN.RECSTAT='A' " & _
" AND PURMAN.DBCD='" & VTCD & "' "

SQL = SQL & "AND PURMAN.DATE >= '" & Format(txtFrDate.Value, "MM/DD/YYYY") & _
            "' AND PURMAN.DATE <= '" & Format(txtToDate.Value, "MM/DD/YYYY") & "' "

If txtpcod <> Empty Then
   SQL = SQL & " AND PURMAN.PCOD = '" & txtpcod.Tag & "'"
End If

SQL = SQL & " ORDER BY PURMAN.VBNO,PURMAN.DATE"
...
SQL = "SELECT PURMAN.*,ACCMST.NAME AS ACNM,REFMST.NAME AS AGENT,TAXMST.NAME AS TAX FROM PURMAN "
SQL = SQL & "INNER JOIN ACCMST ON ACCMST.CODE=PURMAN.PCOD "
SQL = SQL & "INNER JOIN REFMST ON REFMST.CODE = PURMAN.BRCD "
SQL = SQL & "LEFT JOIN TAXMST ON TAXMST.CODE=PURMAN.TXCD "
SQL = SQL & "WHERE PURMAN.COMP='" & compPth & "' AND PURMAN.UNIT='" & UNCD & _
"' AND PURMAN.VTYP='OPC' AND PURMAN.RECSTAT='A' AND PURMAN.DBCD='000001' AND PURMAN.VBNO='" & chln & "'"
