...
Begin VB.Form frm_EXCISECRList 
   ...
   End
End
Attribute VB_Name = "frm_EXCISECRList"
...
Dim O As Integer
    ...
    lstBill.ListItems.Clear
        ...
        "INNER JOIN ACCMST SUPMST ON SUPMST.CODE=EGPMAN.CRAC " & _
        "INNER JOIN ACCMST MFGMST ON MFGMST.CODE=EGPMAN.DRAC " & _
        "INNER JOIN ITMMST ON ITMMST.CODE=EGPMAN.ICOD " & _
        "WHERE EGPMAN.COMP='" & compPth & "' AND EGPMAN.UNIT='" & UNCD & "' AND VTYP='EXC' AND RECSTAT<>'D' AND " & _
        ...
        Else
            Do While Not RS.EOF
                ...
                lstItem.SubItems(6) = Trim(nstr(RS!ITOT, 12, 2))
...
Private Sub CMDOK_Click()
    With frmExcise
      ...
      If RS.State = 1 Then RS.Close
      RS.Open "SELECT * FROM EGPMAN WHERE COMP='" & compPth & "' AND UNIT='" & UNCD & "' AND VTYP='EXC' AND " & _
      ...
      If Not RS.EOF Then
        ...
        If .EXCREG.Text = "RG23-C" Then
            .CENVAT.Text = (RS!CENVAT) * 2
            .EDUCESS.Text = (RS!EDUCESS) * 2
            .HEDUCESS.Text = (RS!H_ED_CESS) * 2
            .TXTCESS.Text = (RS!CESS) * 2
         Else
